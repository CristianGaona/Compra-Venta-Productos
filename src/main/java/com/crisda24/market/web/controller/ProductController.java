package com.crisda24.market.web.controller;
...
public class ProductController {
	...
	public ResponseEntity<List<Product>> getByCategory(@PathVariable int categoryId){
		...
		return  productService.getByCategoryId(categoryId).filter(List::isEmpty).map(products -> new ResponseEntity<>(products, HttpStatus.OK))
